...
Tested up to: 6.9
Tested 'Paid Memberships Pro' plugin up to: 3.6
Tested 'Paid Memberships Pro - WooCommerce Add On' plugin up to: 1.7
Tested 'WooCommerce' plugin up to: 10.0.4
Stable tag: 4.1.2
...
= 4.1.2 (2026-01-07) =
~ Added: option Keep/reset course progress.

= 4.1.1 (2025-09-22) =
~ Fixed: case auto enroll course is free and disable only buy via pms.

= 4.1.0 (2025-07-25) =
~ Check case course has price and purchased, and display button enroll.

= 4.0.9 (2025-06-25) =
~ Fixed: case course free include on the level.
~ Fixed: empty courses on level.
~ Fixed: case not "auto enroll" with courses free on level.

= 4.0.8 (2025-04-22) =
~ Fixed: option change courses on level apply to lp order.

= 4.0.7 (2024-12-16) =
~ Refactor code.
~ Fixed: display tab assign courses on level.
~ Fixed: option "Always buy via membership".
