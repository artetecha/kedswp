...
<div class="welcome-panel-content thim-core-welcome-panel">
	<div class="welcome-panel-header welcome-panel-header-wrap">
	...
	<div class="welcome-panel-column-container">
		...
		<div class="welcome-panel-column">
			...
			<ul>
					...
					<li>
						<div class="welcome-icon welcome-widgets-menus">
							...
							if ( current_theme_supports( 'widgets' ) && current_theme_supports( 'menus' ) ) {
								printf(
									__( 'Manage <a href="%1$s">widgets</a> or <a href="%2$s">menus</a>', 'thim-core' ),
				...
				<?php if ( current_user_can( 'edit_theme_options' ) ) : ?>
					<li>
						<a class="welcome-icon welcome-tc-documentation" href="<?php echo esc_url( $links['docs'] ); ?>"
							target="_blank"><?php esc_html_e( 'Documentation', 'thim-core' ); ?></a>
					</li>

					<li>
						<a class="welcome-icon welcome-tc-support" href="<?php echo esc_url( $links['support'] ); ?>"
							target="_blank"><?php esc_html_e( 'Support', 'thim-core' ); ?></a>
			...
			<?php if ( current_user_can( 'customize' ) ) : ?>
				<a class="button button-primary button-hero load-customize hide-if-no-customize"
					href="<?php echo wp_customize_url(); ?>"><?php _e( 'Customize Your Site', 'thim-core' ); ?></a>
			<?php endif; ?>

			<a class="button button-primary button-hero hide-if-customize"
				href="<?php echo admin_url( 'themes.php' ); ?>"><?php _e( 'Customize Your Site', 'thim-core' ); ?></a>
		...
		<?php if ( ! empty( $data['posts'] ) && is_array( $data['posts'] ) ) : ?>
			<div class="welcome-panel-column welcome-panel-last">
				...
				<div
					class="sub-description"><?php printf( __( 'Check all of it from <a href="%1$s" target="_blank">%2$s</a>', 'thim-core' ), 'https://thimpress.com/', 'Thimpress' ); ?></div>
