<div class="tc-system-status-wrapper wrap">
	...
	<div class="tc-notice tc-info">
		<div class="content">
			...
			<textarea title="tc_draw_system_status" readonly class="widefat copy-text" name="tc_draw_system_status"
						id="tc_draw_system_status" rows="10"><?php echo $args['draw_text']; ?></textarea>

			<div class="btn-copy-container">
				<button class="button button-secondary btn-copy-system-status"
						data-clipboard-target="#tc_draw_system_status"><?php esc_html_e( 'Copy status report', 'thim-core' ); ?></button>
					...
					<tr>
						...
						<td>
							...
							if ( $args['remote_get_successful'] ) {
								...
								echo '<mark class="error"><span class="dashicons dashicons-warning"></span> ' . sprintf( __( 'wp_remote_get() failed. Contact your hosting provider with error: <code>%1$s</code></br> URL: <code>%2$s</code>', 'thim-core' ), esc_html( $args['remote_get_response'] ), esc_url( $args['remote_get_test_url'] ) ) . '</mark>';
							}
							?>
						</td>
					</tr>
