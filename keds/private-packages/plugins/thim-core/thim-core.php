...
if ( ! class_exists( 'TP' ) ) {
	class TP {
		...
		private function define_constants() {
			...
			$this->define( 'THIM_CORE_PATH', __DIR__ );
			...
			$this->define( 'THIM_CORE_VERSION', '2.4.9' );
		...
		public function activated( $plugin ) {
			$plugins_are_activating = isset( $_POST['checked'] ) ? array_map( 'sanitize_text_field', (array) $_POST['checked'] ) : array();
