...
class Thim_Theme_License extends Thim_Admin_Sub_Page {
	...
	public function activate( $request ) {
		...
		try {
			...
			$api_url = Thim_Admin_Config::get( 'api_thim_market' ) . '/license/activate';
			...
			// Tear down any legacy personal_token previously stashed for this
			// theme — the new flow never reads it.
	...
	public function deactivate( $request ) {
		try {
			$api_url = Thim_Admin_Config::get( 'api_thim_market' ) . '/license/deactivate';
