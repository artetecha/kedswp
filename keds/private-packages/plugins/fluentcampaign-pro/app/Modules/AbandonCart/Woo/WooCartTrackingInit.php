...
class WooCartTrackingInit
{
    ...
    public function maybePrefillCheckoutFields($fields)
    {
        ...
        $customerData = [
            'billing'  => array_filter([
                'billing_first_name' => Arr::get($inputs, 'billingAddress.first_name'),
                'billing_last_name'  => Arr::get($inputs, 'billingAddress.last_name'),
                'billing_email'      => $abandonCart->email,
                'billing_company'    => Arr::get($inputs, 'billingAddress.company'),
                'billing_address_1'  => Arr::get($inputs, 'billingAddress.address_1'),
                'billing_address_2'  => Arr::get($inputs, 'billingAddress.address_2'),
                'billing_city'       => Arr::get($inputs, 'billingAddress.city'),
                'billing_state'      => Arr::get($inputs, 'billingAddress.state'),
                'billing_postcode'   => Arr::get($inputs, 'billingAddress.postcode'),
                'billing_country'    => Arr::get($inputs, 'billingAddress.country'),
                'billing_phone'      => Arr::get($inputs, 'billingAddress.phone'),
            ]),
            'shipping' => array_filter([
                'shipping_first_name' => Arr::get($inputs, 'shippingAddress.first_name'),
                'shipping_last_name'  => Arr::get($inputs, 'shippingAddress.last_name'),
                'shipping_company'    => Arr::get($inputs, 'shippingAddress.company'),
                'shipping_address_1'  => Arr::get($inputs, 'shippingAddress.address_1'),
                'shipping_address_2'  => Arr::get($inputs, 'shippingAddress.address_2'),
                'shipping_city'       => Arr::get($inputs, 'shippingAddress.city'),
                'shipping_state'      => Arr::get($inputs, 'shippingAddress.state'),
                'shipping_postcode'   => Arr::get($inputs, 'shippingAddress.postcode'),
                'shipping_country'    => Arr::get($inputs, 'shippingAddress.country'),
            ]),
            'order'    => [
    ...
    public function maybeHandleCartOrderChanged(\WC_Order $order, $abCart = null)
    {
        ...
        $isSuccessfulOrder = AbCartHelper::isWinOrderStatus('woo', $status);
