...
class FluentLicensing
{
    ...
    private function getExpireMessage($licenseData, $scope = 'global')
    {
        ...
        return '<p>Your ' . $this->getConfig('plugin_title') . ' license has been <b>expired at ' . gmdate('d M Y', strtotime($licenseData['expires'])) . '</b>, Please <a href="' . $renewUrl . '"><b>Click Here to Renew Your License</b></a>.</p>';
    }
