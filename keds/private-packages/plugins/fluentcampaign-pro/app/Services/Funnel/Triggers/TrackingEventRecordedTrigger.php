...
class TrackingEventRecordedTrigger extends BaseTrigger
{
    ...
    public function handle($funnel, $originalArgs)
    {
        ...
        if (did_action('fluent_crm/event_tracking_automation_triggered_' . $funnel->id . '_' . $subscriber->id)) {
            return false;
        }
        ...
        do_action('fluent_crm/event_tracking_automation_triggered_' . $funnel->id . '_' . $subscriber->id, $funnel);
