...
class FunnelABTesting
{
    ...
    public function register()
    {
        ...
        add_action('fluentcrm_funnel_sequence_handle_funnel_ab_testing', array($this, 'handle'), 10, 5);
    }
    ...
    public function pushBlock($blocks, $funnel)
    {
        $blocks[$this->name] = [
            ...
            'element-icon'     => 'Guide',//fluentCrmMix('images/funnel_icons/has_contact_property.svg'),
            'settings'         => [
                'path_a' => '50',
                'path_b' => '50'
            ],
    ...
    public function handle($subscriber, $sequence, $funnelSubscriberId, $funnelMetric, $processor = null)
    {
        ...
        $processor->initChildSequences($sequence, $isB, $subscriber, $funnelSubscriberId, $funnelMetric);
    }
