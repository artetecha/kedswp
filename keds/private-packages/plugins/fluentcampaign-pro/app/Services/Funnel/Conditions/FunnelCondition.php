...
class FunnelCondition
{
    ...
    public function register()
    {
        ...
        add_action('fluentcrm_funnel_sequence_handle_funnel_condition', array($this, 'handle'), 10, 5);
    }
    ...
    public function handle($subscriber, $sequence, $funnelSubscriberId, $funnelMetric, $processor = null)
    {
        ...
        $processor->initChildSequences($sequence, $isYes, $subscriber, $funnelSubscriberId, $funnelMetric);
    }
    ...
    protected function assessConditionGroups($conditionGroups, $subscriber, $sequence, $funnelSubscriberId)
    {
        foreach ($conditionGroups as $conditions) {
            $result = $this->assessConditions($conditions, $subscriber, $sequence, $funnelSubscriberId);
            if ($result) {
                return true;
            }
        }
    ...
    protected function assessConditions($conditions, $subscriber, $sequence, $funnelSubscriberId)
    {
