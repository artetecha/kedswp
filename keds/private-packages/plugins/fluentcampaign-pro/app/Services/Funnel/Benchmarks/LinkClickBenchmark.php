        ...
        return [
            ...
            'fields'    => [
                'mask_url'           => [
                    ...
                    'inline_help' => __('Paste this link in any email or page. When a contact click this link then it will be recorded and redirect to the url as provided below.', 'fluentcampaign-pro')
                ],
                'redirect_to' => [
                    'type'        => 'url_selector',
