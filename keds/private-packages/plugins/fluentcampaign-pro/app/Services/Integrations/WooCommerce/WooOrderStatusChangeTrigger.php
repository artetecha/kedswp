...
class WooOrderStatusChangeTrigger extends BaseTrigger
{
    ...
    public function getSettingsFields($funnel)
    {
        return [
            ...
            'sub_title' => __('This Funnel will start when an Order status will change from one state to another', 'fluentcampaign-pro'),
            'fields'    => [
                'subscription_status'      => [
    ...
    public function getConditionFields($funnel)
    {
        ...
        return [
            'product_ids'     => [
                ...
                'inline_help' => __('Keep it blank to run to any product status changed', 'fluentcampaign-pro'),
            ],
            'from_status' => [
                'type' => 'select',
                'label' => __('From Order Status', 'fluentcampaign-pro'),
            ...
            'to_status' => [
                'type' => 'select',
                'label' => __('To Order Status', 'fluentcampaign-pro'),
    ...
    public function handle($funnel, $originalArgs)
    {
        ...
        if (!isset($subscriberData['email']) || !is_email($subscriberData['email'])) {
            return false;
        }
