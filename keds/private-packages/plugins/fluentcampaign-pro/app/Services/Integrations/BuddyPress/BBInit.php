...
class BBInit
{
    ...
    {
        $providers['buddypress'] = [
            'title'       => __('BuddyPress', 'fluentcampaign-pro'),
            'sub_title'   => __('With BuddyPress integration with FluentCRM, you easily track your community membership, display group information and segment contacts.', 'fluentcampaign-pro'),
            'type'        => 'membership',
            'is_enabled' => true,
            'settings'    => null
        ];
