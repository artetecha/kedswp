...
class SureCartPaymentRefundTrigger extends BaseTrigger
{
    public function __construct()
    {
        $this->triggerName = 'fluent_surecart_purchase_refund_wrap';
        $this->priority = 10;
        $this->actionArgNum = 1;
        parent::__construct();
    }
...
<script xmlns=""/></svg>'
    ...
    {
        return [
            'title'     => __('SureCart Order Revoke', 'fluentcampaign-pro'),
            'sub_title' => __('This Funnel will start once order will be refunded', 'fluentcampaign-pro'),
            'fields'    => [
                'subscription_status'      => [
