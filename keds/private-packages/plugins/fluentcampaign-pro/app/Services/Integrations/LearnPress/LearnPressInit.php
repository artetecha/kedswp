...
class LearnPressInit
{
    ...
    public function addDeepIntegrationProvider($providers)
    {
        $providers['learnpress'] = [
                'title'       => __('LearnPress', 'fluentcampaign-pro'),
                'sub_title'   => __('With LearnPress integration with FluentCRM, you easily track your courses, it enables automatic tagging, student segmentation etc.', 'fluentcampaign-pro'),
                'type'        => 'lms',
                'is_enabled'  => true,
