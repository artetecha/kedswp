...
class EddCommerceHelper
{
    ...
    /**
     * Sync a single EDD 3 customer into FluentCRM commerce relations.
     *
     * @param object|int $customer
    ...
    public static function syncCommerceCustomer($customer, $contactStatus = 'subscribed', $paymentStatuses = [], $tags = [], $lists = [], $sendDoubleOptin = true)
    {
        ...
        /*
         * EDD 3 stores canonical order records in edd_orders. Do not fall back
         * to legacy edd_payment posts because EDD 2 is no longer supported.
         */
