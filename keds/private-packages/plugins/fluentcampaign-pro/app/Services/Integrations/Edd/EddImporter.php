...
class EddImporter extends BaseImporter
{
    ...
    /**
     * Get the importer metadata when EDD 3 is available.
     *
     * @return array|false
     */
    ...
    /**
     * Build the import step configuration for EDD 3 customer imports.
     *
     * @param array $config
    ...
    {
        if (!Helper::isEdd3()) {
            return new \WP_Error('not_supported', __('Easy Digital Downloads 3 is required for this importer.', 'fluentcampaign-pro'));
        }
