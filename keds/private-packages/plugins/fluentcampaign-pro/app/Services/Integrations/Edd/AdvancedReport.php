...
class AdvancedReport extends BaseAdvancedReport
{
    ...
    /**
     * Determine if the current request can access EDD 3 reports.
     *
     * @return bool
     */
    private function haveAccess()
    {
        return Helper::isEdd3() && apply_filters('fluent_crm/user_can_view_edd_report', current_user_can('view_shop_sensitive_data'));
    }
}
