...
class VoxelInit
{
    ...
    {
        $providers['voxel'] = [
            'title'       => __('Voxel', 'fluentcampaign-pro'),
            'sub_title'   => __('With Voxel integration with FluentCRM, you can track customer orders, run automated funnels based on order placement, segment customers by purchase history, and manage contact profiles directly from the CRM.', 'fluentcampaign-pro'),
            'type'        => 'commerce',
            'is_enabled'  => true,
            'settings'    => null
        ];
