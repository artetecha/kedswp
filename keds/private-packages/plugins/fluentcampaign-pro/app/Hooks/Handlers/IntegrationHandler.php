...
use FluentCampaign\App\Services\Funnel\Actions\SendCustomSmsAction;
...
class IntegrationHandler
{
    ...
    public function maybeAutoAlterTags($userId, $newRole)
    {
        ...
        } else if($subscriber->user_id != $user->ID) {
    ...
    public function runBirthDayAction()
    {
        ...
        if (!$subscribers) {
            fluentcrm_update_option('_last_bday_last_run', gmdate('Y-m-d H:i:s'));
            return false;
        }
