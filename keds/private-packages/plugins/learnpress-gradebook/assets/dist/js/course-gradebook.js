...
/***/ "./assets/src/js/admin/gradebook-sortable.js"
/*!***************************************************!*\
  !*** ./assets/src/js/admin/gradebook-sortable.js ***!
  \***************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/**
 * Shared sortable-column handler for gradebook AJAX tables.
 *
 * Binds to any `th.sortable` rendered inside a TemplateAJAX `.lp-target` area
 * (course-gradebook, user-course-gradebook, user-quiz-gradebook). Toggles the
 * sort_field / sort_direction on the stored data-set (preserving active filters),
 * resets paging, then refetches and replaces the target content.
 *
 * @since 4.1.2
 */
...
/**
 * Click handler — sort a gradebook table by the clicked column.
 *
 * @param {Object}      args
 * @param {Event}       args.e
...
var onSort = function onSort(_ref) {
  var e = _ref.e,
    target = _ref.target;
  var th = target.closest('th.lp-gradebook-sortable');
  if (!th) {
    return;
  }
  var elLPTarget = th.closest('.lp-target');
...
(0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.eventHandlers)('click', [{
  selector: 'th.lp-gradebook-sortable',
  callBack: onSort
}]);

/***/ },

/***/ "./assets/src/js/course-chart.js"
/*!***************************************!*\
  !*** ./assets/src/js/course-chart.js ***!
  \***************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/**
 * Course chart JS — pie + bar chart for the course gradebook page.
 *
 * @since 4.0.0
 * @version 1.0.1
 */
...
var gradebookCourseBarChar, gradebookCoursePieChart;

/**
 * Fetch pie-chart data for the course and render it.
 *
 * @param {number|string} courseID
 * @return {Promise<void>}
 */
var getPieChart = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(courseID) {
    var response, _yield$response, data, message, status;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.n = 1;
          return wp.apiFetch({
            path: wp.url.addQueryArgs('lp-gradebook/get-pie-chart-student', {
              courseID: courseID
            }),
            method: 'GET'
          });
        ...
        case 3:
          renderPieChart(data, message);
        case 4:
          return _context.a(2);
      }
    }, _callee);
  }));
  return function getPieChart(_x) {
    return _ref.apply(this, arguments);
  };
}();

/**
 * Render the course pie chart into .pie-chart-canvas.
 *
 * @param {Object} data  { labels, datasets: { backgroundColor, borderColor, data } }
 * @param {string} title
 */
var renderPieChart = function renderPieChart(data) {
  var title = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Pie chart';
  var canvas = document.querySelector('.pie-chart-canvas');
  gradebookCoursePieChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_1__["default"](canvas, {
    type: 'pie',
    data: {
      labels: data.labels,
      datasets: [{
...
/**
 * Fetch bar-chart data for a date range and render it, then reset the button.
 *
 * @param {number|string} courseID
 * @param {string}        typeChart Date-range key (e.g. 'last-7-days').
 * @param {HTMLElement}   button    Button to re-enable / clear spinner on.
 * @return {Promise<void>}
 */
var getBarChart = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(courseID, typeChart, button) {
    var response, _yield$response2, data, message, status, spinner;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.n = 1;
          return wp.apiFetch({
            path: wp.url.addQueryArgs('lp-gradebook/get-chart-student', {
              courseID: courseID,
              typeChart: typeChart
            }),
            method: 'GET'
        ...
        case 2:
          ...
          throw new Error(message);
        case 3:
          renderBarChart(data.labels, data.datasets, data.title);
          spinner = button.querySelector('span:not(.dashicons)');
          if (spinner) {
            spinner.className = '';
          }
  ...
  return function getBarChart(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

/**
 * Build the bar chart on first call, or update its data on subsequent calls.
 *
 * @param {Array}  labels
...
var renderBarChart = function renderBarChart() {
  ...
  var title = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'chart';
  if (undefined === gradebookCourseBarChar) {
    var canvas = document.querySelector('.bar-chart-canvas');
    gradebookCourseBarChar = new chart_js_auto__WEBPACK_IMPORTED_MODULE_1__["default"](canvas, {
      type: 'bar',
      data: {
        labels: labels,
        datasets: datasets
    ...
    gradebookCourseBarChar.data.labels = labels;
    gradebookCourseBarChar.data.datasets = datasets;
    gradebookCourseBarChar.update();
  }
};

/**
 * Look up the course-chart wrapper and its data-course attribute on demand.
 *
 * Re-read on each click to survive late DOM injection by the parent page.
 *
 * @return {{ wrapper: HTMLElement|null, courseID: string|undefined }}
 */
var getCourseID = function getCourseID() {
  var wrapper = document.querySelector('.course-chart-wrapper');
  return {
    wrapper: wrapper,
    courseID: wrapper === null || wrapper === void 0 ? void 0 : wrapper.dataset.course
  };
};

/**
 * Click handler — toggle the chart wrapper open/closed and lazy-load the
 * pie + bar charts on the first open.
 *
 * @param {Object}      args
 * @param {HTMLElement} args.target
 */
var onViewChart = function onViewChart(_ref3) {
  var target = _ref3.target;
  var btn = target.closest('.view-chart-button');
  if (!btn) {
    return;
  }
  var _getCourseID = getCourseID(),
    wrapper = _getCourseID.wrapper,
    courseID = _getCourseID.courseID;
  if (!wrapper) {
    return;
  }
  if (wrapper.style.display === 'none') {
    wrapper.style.display = 'flex';
    btn.innerHTML = "".concat((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Close Chart', 'learnpress-gradebook'), "<span class=\"dashicons dashicons-arrow-down-alt\"></span><span></span>");
  } else {
    btn.innerHTML = "".concat((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('View Chart', 'learnpress-gradebook'), "<span class=\"dashicons dashicons-chart-area\"></span> <span></span>");
    wrapper.style.display = 'none';
  }
  if (undefined === gradebookCoursePieChart) {
    getPieChart(courseID);
  }
  if (undefined === gradebookCourseBarChar) {
    btn.disabled = true;
    getBarChart(courseID, 'last-7-days', btn);
    var spinner = btn.querySelector('span:not(.dashicons)');
    if (spinner) {
...
/**
 * Click handler — refetch bar-chart data for the selected date range.
 *
 * @param {Object}      args
 * @param {HTMLElement} args.target
 */
var onFilterChart = function onFilterChart(_ref4) {
  var target = _ref4.target;
  var btn = target.closest('.bar-chart-filter-button');
  if (!btn) {
    return;
  }
  var _getCourseID2 = getCourseID(),
    wrapper = _getCourseID2.wrapper,
    courseID = _getCourseID2.courseID;
  if (!wrapper) {
    return;
  }
  btn.disabled = true;
  ...
  getBarChart(courseID, btn.dataset.filter, btn);
};
(0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.eventHandlers)('click', [{
  selector: '.view-chart-button',
  callBack: onViewChart
}, {
  selector: '.bar-chart-filter-button',
...
var submitFilter = function submitFilter(form, callBack) {
  ...
  var lpTargetY = form.getBoundingClientRect().top + window.scrollY - 100;
  window.scrollTo({
    top: lpTargetY
  });
...
"use strict";
/*!*******************************************!*\
  !*** ./assets/src/js/course-gradebook.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @woocommerce/csv-export */ "./node_modules/@woocommerce/csv-export/build-module/index.js");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils.js */ "./assets/src/js/utils.js");
/* harmony import */ var _gradebook_admin_share_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./gradebook-admin-share.js */ "./assets/src/js/gradebook-admin-share.js");
/* harmony import */ var _course_chart_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./course-chart.js */ "./assets/src/js/course-chart.js");
/* harmony import */ var _admin_gradebook_sortable_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./admin/gradebook-sortable.js */ "./assets/src/js/admin/gradebook-sortable.js");
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
/**
 * Course gradebook list page JS — export CSV + filter.
 *
 * @since 4.0.0
 * @version 1.0.1
 */
...
/**
 * Fetch enrolled-student rows for the course and trigger a CSV download.
 *
 * @param {number|string} courseID
 * @return {Promise<void>}
 */
var getDataExport = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(courseID) {
    var response, data, dataForm, name;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.n = 1;
          return wp.apiFetch({
            path: wp.url.addQueryArgs('lp-gradebook/export-students', {
              courseID: courseID
            }),
            method: 'GET'
          });
        ...
        case 2:
          data = _context.v;
          _context.n = 3;
          return (0,_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_0__.generateCSVDataFromTable)(HEADERS, data);
        case 3:
          dataForm = _context.v;
          _context.n = 4;
          return (0,_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_0__.generateCSVFileName)('gradebook', {
            list: 'students'
          });
        case 4:
          name = _context.v;
          (0,_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_0__.downloadCSVFile)(name, dataForm);
        case 5:
          return _context.a(2);
      }
    }, _callee);
...
/**
 * Page through the full-export endpoint, then trigger a CSV download with the
 * accumulated header + row data.
 *
 * @param {number|string} courseID
 * @return {Promise<void>}
 */
var getDataExportFull = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(courseID) {
    var response, headerData, dataList, dataForm, name;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.n = 1;
          return _getRequest([], [], courseID, 10, 1);
        case 1:
          response = _context2.v;
          if (response) {
            _context2.n = 2;
        ...
        case 2:
          ...
          dataForm = (0,_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_0__.generateCSVDataFromTable)([].concat(HEADERS_FULL, _toConsumableArray(headerData)), dataList);
          name = (0,_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_0__.generateCSVFileName)('gradebook', {
            list: 'students'
          });
          (0,_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_0__.downloadCSVFile)(name, dataForm);
        case 3:
  ...
  return function getDataExportFull(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

/**
 * Recursively fetch one page of full-export data, accumulating header + rows.
 *
 * @param {Array}         headerData Accumulated header columns.
 * @param {Array}         dataList   Accumulated row data.
 * @param {number|string} courseID
 * @param {number}        limit      Page size.
 * @param {number}        offset     Page number (1-based).
 * @return {Promise<{headerData: Array, dataList: Array}|false>}
 */
var _getRequest = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(headerData, dataList, courseID, limit, offset) {
    var response, status, data, header, count;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          _context3.n = 1;
          return wp.apiFetch({
            path: wp.url.addQueryArgs('lp-gradebook/export-students-full', {
              courseID: courseID,
              limit: limit,
              offset: offset
            }),
        ...
        case 2:
          ...
          return _context3.a(2, _getRequest(headerData, dataList, courseID, limit, offset + 1));
        case 3:
  ...
  return function getRequest(_x3, _x4, _x5, _x6, _x7) {
    return _ref3.apply(this, arguments);
  };
}();

/**
 * Click handler — export the short CSV for the course in the button's data-course.
 *
 * @param {Object}      args
 * @param {HTMLElement} args.target
 */
var onExport = function onExport(_ref4) {
  var target = _ref4.target;
  var btn = target.closest('.lp-gradebook-export-csv');
  if (btn !== null && btn !== void 0 && btn.dataset.course) {
    getDataExport(btn.dataset.course);
  }
};

/**
 * Click handler — export the full (paged) CSV for the course.
 *
 * @param {Object}      args
 * @param {HTMLElement} args.target
 */
var onExportFull = function onExportFull(_ref5) {
  var target = _ref5.target;
  var btn = target.closest('.lp-gradebook-export-full-csv');
  if (btn !== null && btn !== void 0 && btn.dataset.course) {
    getDataExportFull(btn.dataset.course);
  }
};

/**
 * Click handler — submit the user-filter form and re-render the result area.
 *
 * @param {Object}      args
 * @param {HTMLElement} args.target
 */
var onSearch = function onSearch(_ref6) {
  ...
  var btn = target.closest('.search-user-button');
  if (btn) {
    (0,_gradebook_admin_share_js__WEBPACK_IMPORTED_MODULE_3__.submitFilterFront)(btn);
  }
};
(0,_utils_js__WEBPACK_IMPORTED_MODULE_2__.eventHandlers)('click', [{
  selector: '.lp-gradebook-export-csv',
  callBack: onExport
}, {
  selector: '.lp-gradebook-export-full-csv',
  callBack: onExportFull
}, {
  selector: '.search-user-button',
  callBack: onSearch
}]);
})();
...
/******/ })()
;
//# sourceMappingURL=course-gradebook.js.map