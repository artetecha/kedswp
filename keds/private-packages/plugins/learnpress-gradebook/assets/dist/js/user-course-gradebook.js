...
"use strict";
/*!************************************************!*\
  !*** ./assets/src/js/user-course-gradebook.js ***!
  \************************************************/
__webpack_require__.r(__webpack_exports__);
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
/**
 * User-course gradebook (items) page JS — export CSV + filter.
 *
 * @since 4.0.0
 * @version 1.0.1
 */
...
/**
 * Fetch course items for a single student and trigger a CSV download.
 *
 * @param {number|string} courseID
 * @param {number|string} studentID
 * @return {Promise<void>}
 */
var exportItem = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(courseID, studentID) {
    var response, dataForm, name;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.n = 1;
          return wp.apiFetch({
            path: wp.url.addQueryArgs('lp-gradebook/export-items', {
              studentID: studentID,
              courseID: courseID
            }),
            method: 'GET'
        ...
        case 1:
          ...
          if (response !== null && response !== void 0 && response.data) {
            dataForm = (0,_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_0__.generateCSVDataFromTable)(HEADER_EXPORT, response.data);
  ...
  return function exportItem(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

/**
 * Click handler — export items CSV for the (course, student) on the button.
 *
 * @param {Object}      args
 * @param {HTMLElement} args.target
 */
var onExport = function onExport(_ref2) {
  var target = _ref2.target;
  var btn = target.closest('.lp-gradebook-export-csv');
  if (btn) {
    exportItem(btn.dataset.course, btn.dataset.student);
  }
};

/**
 * Click handler — submit the item-filter form and re-render the result area.
 *
 * @param {Object}      args
 * @param {HTMLElement} args.target
 */
...
/******/ })()
;
//# sourceMappingURL=user-course-gradebook.js.map