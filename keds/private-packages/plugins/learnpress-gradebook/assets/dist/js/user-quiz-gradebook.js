...
"use strict";
/*!**********************************************!*\
  !*** ./assets/src/js/user-quiz-gradebook.js ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _gradebook_admin_share_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./gradebook-admin-share.js */ "./assets/src/js/gradebook-admin-share.js");
...
/**
 * User-quiz gradebook (questions) page JS — chart, export, retake dropdown, filter.
 *
 * @since 4.0.0
 * @version 1.0.1
 */
...
/**
 * Fetch question-distribution pie-chart data for the quiz and render it.
 *
 * @param {number|string} courseID
 * @param {number|string} quizzID
 * @param {number|string} studentID
 * @return {Promise<void>}
 */
var getPieChart = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(courseID, quizzID, studentID) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.n = 1;
          return wp.apiFetch({
            path: wp.url.addQueryArgs('lp-gradebook/get-chart-questions', {
              courseID: courseID,
              quizzID: quizzID,
              studentID: studentID
            }),
  ...
  return function getPieChart(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

/**
 * Render the question pie chart into .pie-chart-canvas.
 *
...
var renderPieChart = function renderPieChart(data) {
  ...
  gradebookQuizPieChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_2__["default"](canvas, {
    type: 'pie',
    data: {
      labels: data.labels,
      datasets: [{
...
/**
 * Fetch the quiz questions export and trigger a CSV download.
 *
 * Uses the localized gradebookUserQuizData (course_id / quiz_id / user_id).
 *
 * @return {Promise<void>}
 */
var exportQuestions = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.n = 1;
          return wp.apiFetch({
            path: wp.url.addQueryArgs('lp-gradebook/export-questions', {
              courseID: gradebookUserQuizData.course_id,
              quizzID: gradebookUserQuizData.quiz_id,
              studentID: gradebookUserQuizData.user_id
            }),
            method: 'GET'
          });
        case 1:
          response = _context2.v;
          dataForm = (0,_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_0__.generateCSVDataFromTable)(HEADER_EXPORT, response.data["export"]);
  ...
  return function exportQuestions() {
    return _ref2.apply(this, arguments);
  };
}();

/**
 * Click handler — toggle the retake-details dropdown next to the clicked button.
 *
 * @param {Object}      args
 * @param {HTMLElement} args.target
 */
var onRetake = function onRetake(_ref3) {
  var _target$closest;
  var target = _ref3.target;
  var dropdown = (_target$closest = target.closest('.lp-gradebook-dropbtn')) === null || _target$closest === void 0 ? void 0 : _target$closest.closest('.lp-gradebook-dropdown');
  var dropdownContent = dropdown === null || dropdown === void 0 ? void 0 : dropdown.querySelector('.lp-gradebook-dropdown-content');
  if (dropdownContent) {
    dropdownContent.classList.toggle('lp-gradebook-show');
  }
};

/**
 * Click handler — submit the question-filter form and re-render the result area.
 *
 * @param {Object}      args
 * @param {HTMLElement} args.target
 */
var onSearch = function onSearch(_ref4) {
  ...
  var btn = target.closest('.lp-gradebook-search-button');
  if (btn) {
    (0,_gradebook_admin_share_js__WEBPACK_IMPORTED_MODULE_4__.submitFilterFront)(btn);
  }
};

/**
 * Click handler — toggle the chart panel; lazy-load pie chart on first open.
 *
 * @param {Object}      args
 * @param {HTMLElement} args.target
 */
var onViewChart = function onViewChart(_ref5) {
  var target = _ref5.target;
  var btn = target.closest('.view-chart-button');
  if (!btn) {
    return;
  }
  var quizChartWrapper = document.querySelector('.quiz-chart-wrapper');
  if (!quizChartWrapper) {
    return;
  }
  if (quizChartWrapper.style.display === 'none') {
    quizChartWrapper.style.display = 'flex';
    btn.innerHTML = "".concat((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Close Chart', 'learnpress-gradebook'), "<span class=\"dashicons dashicons-arrow-down-alt\"></span><span></span>");
  } else {
    btn.innerHTML = "".concat((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('View Chart', 'learnpress-gradebook'), "<span class=\"dashicons dashicons-chart-area\"></span> <span></span>");
    quizChartWrapper.style.display = 'none';
  }
  if (undefined === gradebookQuizPieChart && window.gradebookUserQuizData) {
    getPieChart(gradebookUserQuizData.course_id, gradebookUserQuizData.quiz_id, gradebookUserQuizData.user_id);
  }
};

/**
 * Click handler — trigger the questions CSV export.
 *
 * @param {Object}      args
 * @param {HTMLElement} args.target
 */
var onExport = function onExport(_ref6) {
  var target = _ref6.target;
  if (target.closest('.lp-gradebook-export-csv')) {
    exportQuestions();
  }
};
(0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.eventHandlers)('click', [{
  selector: '.lp-gradebook-dropbtn',
  callBack: onRetake
}, {
  selector: '.lp-gradebook-search-button',
  callBack: onSearch
}, {
...
/******/ })()
;
//# sourceMappingURL=user-quiz-gradebook.js.map