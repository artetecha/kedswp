...
if ( ! isset( $cert )
	|| ! $cert instanceof LP_Certificate
	|| ! isset( $courseModel ) ) {
	die();
}
?>
...
<head>
	...
	<meta property="og:title" content="<?php echo esc_attr( $cert->get_title() . ' &rsaquo; ' . $courseModel->get_title() ); ?>"/>
	...
	<title><?php echo esc_html( $courseModel->get_title() . ' &lsaquo; ' . $cert->get_title() ); ?></title>
