...
~ Fix: handle undefined array keys in certificate templates.
~ Fixed: get content image certificate.

= 4.2.3 (2026-05-12) =
~ Added: feature manager Certificate on Course Builder.
~ Fixed: error blank certificate.

= 4.2.2 (2026-04-11) =
~ Fixed: minor bug.

= 4.2.1 (2026-03-30) =
~ Improve: load styles on builder.
~ Fixed: error load font Georgia.
~ Tweak: styles.
~ Tweak: labels.

= 4.2.0 (2026-03-20) - Big update =
~ New builder for certificate.
~ New config certificate for screen edit course.

= 4.1.7 (2025-09-19) =
~ Fixed: compatible with PHP 8.4
~ Change capability type.
~ Tweak: format date.
~ Tweak: lp_user_cer_update.
~ Added: UserCertificateModel class.

= 4.1.6 (2025-04-29) =
~ Added: crypto-js
~ Fixed: JSON.stringify( layer ).md5() conflict with other plugins

= 4.1.5 (2025-03-06) =
~ Fixed: buy 2 certs with LP Woo payment.
~ Clean code.
