 ...
 * @version 1.0.1
 */
class WooGateway extends LP_Gateway_Abstract {
	/**
	 * @var string
	 */
	 ...
	 * @return bool
	 */
	public static function is_enable_run_background(): bool {
		$option = LP_Settings::get_option( 'woo-payment_run_background', 'no' );
