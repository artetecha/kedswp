...
class Thim_Ekit_Widget_Portfolio extends Widget_Base {
	...
	public function get_icon() {
		return 'eduma-eicon thim-widget-icon thim-widget-icon-portfolio';
	}
	...
	public function get_script_depends() {
		return [ 'thim-portfolio-widget', 'thim-portfolio-appear' ];
	}
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'style11' => esc_html__( 'Caption Hover Effects 11', 'eduma' ),
				],
				'default' => 'style01',
			]
		);
