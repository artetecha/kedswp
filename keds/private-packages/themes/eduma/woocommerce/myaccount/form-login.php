		...
		<form method="post" class="login">
			...
			<p class="form-row form-row-wide">
				<input type="text" class="input-text" name="username" id="username" autocomplete="username"
						...
						aria-label="<?php esc_attr_e( 'Username or email address', 'eduma' ); ?>"/>
			</p>

			<p class="form-row form-row-wide">
				<input class="input-text" type="password" name="password" id="password" autocomplete="current-password"
						placeholder="<?php esc_attr_e( 'Password', 'eduma' ); ?>"
			...
			<form method="post" class="register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
				...
				<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
					...
					<p class="form-row form-row-wide">
						<input type="text" class="input-text" name="username" id="reg_username"
								placeholder="<?php esc_html_e( 'Username', 'eduma' ); ?>" autocomplete="username"
								value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>"
								aria-label="<?php esc_attr_e( 'Username', 'eduma' ); ?>"/>
					</p>
				...
				<p class="form-row form-row-wide">
					<input type="email" class="input-text" name="email" id="reg_email"
							placeholder="<?php esc_html_e( 'Email address', 'eduma' ); ?>" autocomplete="email"
							value="<?php echo ( ! empty( $_POST['email'] ) ) ? esc_attr( wp_unslash( $_POST['email'] ) ) : ''; ?>"
							aria-label="<?php esc_attr_e( 'Email address', 'eduma' ); ?>"/>
				</p>
				...
				<p class="form-row">
					...
					<input type="submit" class="button" name="register"
							...
							aria-label="<?php esc_attr_e( 'Register', 'eduma' ); ?>"/>
				</p>
