...
$per_page = get_theme_mod( 'thim_team_cate_per_page', 12 );
				...
				<div class="our-team-item col-sm-3 col-xs-6">
					<div class="our-team-image">
						...
						<div class="social-team">
							<?php if ( $link_face <> '' ) : ?>
								<a href="<?php echo $link_face; ?>"><i class="edu-facebook"></i></a>
							<?php endif; ?>
							<?php if ( $link_twitter <> '' ) : ?>
								<a href="<?php echo $link_twitter; ?>"><i class="edu-x-twitter"></i></a>
							<?php endif; ?>
							<?php if ( $dribbble_url <> '' ) : ?>
								<a href="<?php echo $dribbble_url; ?>"><i class="edu-dribbble"></i></a>
							<?php endif; ?>
							<?php if ( $skype_url <> '' ) : ?>
								<a href="<?php echo $skype_url; ?>"><i class="edu-skype"></i></a>
							<?php endif; ?>
							<?php if ( $linkedin_url <> '' ) : ?>
								<a href="<?php echo $linkedin_url; ?>"><i class="edu-linkedin"></i></a>
							<?php endif; ?>
