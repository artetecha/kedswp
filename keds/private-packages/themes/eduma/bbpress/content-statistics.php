	...
	<dl role="main">
		...
		<?php if ( ! empty( $stats['topic_count_hidden'] ) ) : ?>
			...
			<dd>
				<strong>
					<abbr
						title="<?php echo esc_attr( $stats['hidden_topic_title'] ); ?>"><?php echo esc_html( $stats['topic_count_hidden'] ); ?></abbr>
				</strong>
			</dd>
		...
		<?php if ( ! empty( $stats['reply_count_hidden'] ) ) : ?>
			...
			<dd>
				<strong>
					<abbr
						title="<?php echo esc_attr( $stats['hidden_reply_title'] ); ?>"><?php echo esc_html( $stats['reply_count_hidden'] ); ?></abbr>
				</strong>
			</dd>
