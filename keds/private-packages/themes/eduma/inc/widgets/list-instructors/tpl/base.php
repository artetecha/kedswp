...
if ( ! empty( $co_instructors ) ) {
	...
	foreach ( $co_instructors as $key => $instructor ) {
		...
		$html_social = $class_has_social = ''; //phpcs:ignore
		if ( isset( $lp_info['facebook'] ) && $lp_info['facebook'] ) {
			$html_social .= '<li><a href="' . esc_url( $lp_info['facebook'] ) . '" class="facebook"><i class="edu-facebook"></i></a></li>';
		}
		...
		if ( isset( $lp_info['instagram'] ) && $lp_info['instagram'] ) {
			$html_social .= '<li><a href="' . esc_url( $lp_info['instagram'] ) . '" class="instagram"><i class="edu-instagram"></i></a></li>';
		}
		if ( isset( $lp_info['linkedin'] ) && $lp_info['linkedin'] ) {
			$html_social .= '<li><a href="' . esc_url( $lp_info['linkedin'] ) . '" class="linkedin"><i class="edu-linkedin"></i></a></li>';
		}
