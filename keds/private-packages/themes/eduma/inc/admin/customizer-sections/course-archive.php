...
// Enable or disable bottom New Courses
thim_customizer()->add_field(
	array(
		'id'                => 'thim_learnpress_cate_show_new',
		'type'              => 'switch',
		'label'             => esc_html__( 'Show New Courses', 'eduma' ),
		'tooltip'           => esc_html__( 'Check this box to hide/show new Courses.', 'eduma' ),
		'section'           => 'course_archive',
		'default'           => false,
		'priority'          => 26,
		'wrapper_attrs' => array(
...
thim_customizer()->add_field(
	array(
		'id'            => 'thim_learnpress_cate_new_number',
		'type'          => 'number',
		'label'         => esc_html__( 'Number of New Courses', 'eduma' ),
		'tooltip'       => esc_html__( 'Set the number of new courses to display.', 'eduma' ),
		'section'       => 'course_archive',
		'default'       => 3,
		'priority'      => 27,
		'choices'       => array(
		...
		'active_callback' => array(
			array(
				'setting'  => 'thim_learnpress_cate_show_new',
				'operator' => '==',
				'value'    => true,
			),
		),
...
//
if ( ! thim_is_new_learnpress( '4.2.6' ) ) {
	thim_customizer()->add_field(
		array(
			'type'          => 'select',
	...
	thim_customizer()->add_field(
		array(
			'type'          => 'tp_notice',
			'id'            => 'thim_learnpress_cate_layout_grid_info',
			'label'         => esc_html__( 'Layout Grid/List Courses', 'eduma' ),
			'priority'      => 28,
			'section'       => 'course_archive',
			'description'   => sprintf( __( 'Choose Archive page layout default %s.', 'eduma' ), '<a href="' . admin_url( 'admin.php?page=learn-press-settings&tab=courses' ) . '" target="_blank">' . __( 'in here', 'eduma' ) . '</a>' ),
			'wrapper_attrs' => array(
				'class' => '{default_class}' . thim_customizer_extral_class( 'archive-course' ),
			),
		)
