...
thim_customizer()->add_field(
	array(
		...
		'description'   => sprintf(
			__(
				'This page is built by Thim Elementor Kit, you can edit and configure it in %s.',
				'eduma'
			),
			'<a href="' . admin_url( 'edit.php?post_type=thim_elementor_kit&thim_elementor_type=archive-product' ) . '" target="_blank">' . __(
				'Thim Elementor Kit',
				'eduma'
			) . '</a>'
		),
...
thim_customizer()->add_field(
	array(
		...
		'tooltip'       => esc_html__(
			'If you do not use background image, then can use background color for page title on heading top. ',
			'eduma'
		),
		'section'       => 'product_archive',
