...
function thim_eduma_list_child_themes() {
	return array(
		'eduma-child' => array(
			'name'       => 'Eduma Child',
			'slug'       => 'eduma-child',
			'screenshot' => 'https://updates.thimpress.com/images/eduma-child.png',
...
if ( ! function_exists( 'thim_import_add_basic_settings' ) ) {
	function thim_import_add_basic_settings( $settings ) {
		...
		// key for import demo build with elementor v4
		$settings[] = 'elementor_experiment-e_atomic_elements';
		$settings[] = 'elementor_experiment-e_opt_in_v4';
